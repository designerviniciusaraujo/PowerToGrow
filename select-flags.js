  ...
  sr.reveal('.revel', { duration: 1500 });
      ...
      if(x=="esp"){
        innerCont.innerHTML="<p class=PMs>Por favor, selecciona un país arriba para conocer los criterios de elegibilidad.</p>"
  ...
  for (var i = 0; i < getBox.length; i++) {
    ...
    getBox[i].onclick=function(){
      ...
      var btnRead=btnToggle.childNodes[1]
      btnRead.classList.toggle("hidden");
      // boxThis.classList.toggle("hidden") ;
